...
exports.searchBook = exports.deleteBook = exports.getBooksNumber = exports.buyBook = exports.updateBook = exports.addBook = exports.getBook = exports.getAllBooks = void 0;
...
const addBook = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const css = yield (0, pixelExtractor_1.getPixelData)(image);
    let font;
    let boxShadowValue;
...
const searchBook = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { name } = req.query;
    if (!name) {
        throw (0, errors_1.searchError)();
    }
...
const getBooksNumber = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const book = yield book_1.default.countDocuments();
    res.status(200).json({ count: book });
}));
exports.getBooksNumber = getBooksNumber;
const buyBook = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!(book === null || book === void 0 ? void 0 : book.quantity) ||
        ...
        requestedQuantity <= 0)
        throw (0, errors_1.quantityError)();
