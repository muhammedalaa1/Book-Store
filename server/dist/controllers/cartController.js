...
exports.applyCoupon = exports.clearCart = exports.decreaseAmount = exports.createCart = exports.getUserCart = void 0;
...
const getUserCart = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!userId)
        throw (0, errors_1.cartUserError)();
...
const createCart = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const decreaseAmount = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { userId, bookId, quantity } = req.body;
...
const clearCart = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
