...
router
    ...
    .post((0, authentication_1.allowAdmin)("admin"), uploadImage_1.uploadSingleImage, Controller.addBook);
...
router
    ...
    .delete((0, authentication_1.allowAdmin)("admin"), Controller.deleteBook);
